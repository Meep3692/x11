...
public enum KeySym implements IntValue {
  ...
  hpXK_DeleteLine(0x1000FF71),

  hpXK_InsertChar(0x1000FF72),

  hpXK_DeleteChar(0x1000FF73),

  hpXK_BackTab(0x1000FF74),

  hpXK_KP_BackTab(0x1000FF75),

  hpXK_Modelock1(0x1000FF48),

  hpXK_Modelock2(0x1000FF49),

  hpXK_Reset(0x1000FF6C),

  hpXK_System(0x1000FF6D),

  hpXK_User(0x1000FF6E),

  hpXK_mute_acute(0x100000A8),

  hpXK_mute_grave(0x100000A9),

  hpXK_mute_asciicircum(0x100000AA),

  hpXK_mute_diaeresis(0x100000AB),

  hpXK_mute_asciitilde(0x100000AC),

  hpXK_lira(0x100000AF),

  hpXK_guilder(0x100000BE),

  hpXK_Ydiaeresis(0x100000EE),

  hpXK_IO(0x100000EE),

  hpXK_longminus(0x100000F6),

  hpXK_block(0x100000FC),

  osfXK_Copy(0x1004FF02),

  osfXK_Cut(0x1004FF03),

  osfXK_Paste(0x1004FF04),

  osfXK_BackTab(0x1004FF07),

  osfXK_BackSpace(0x1004FF08),

  osfXK_Clear(0x1004FF0B),

  osfXK_Escape(0x1004FF1B),

  osfXK_AddMode(0x1004FF31),

  osfXK_PrimaryPaste(0x1004FF32),

  osfXK_QuickPaste(0x1004FF33),

  osfXK_PageLeft(0x1004FF40),

  osfXK_PageUp(0x1004FF41),

  osfXK_PageDown(0x1004FF42),

  osfXK_PageRight(0x1004FF43),

  osfXK_Activate(0x1004FF44),

  osfXK_MenuBar(0x1004FF45),

  osfXK_Left(0x1004FF51),

  osfXK_Up(0x1004FF52),

  osfXK_Right(0x1004FF53),

  osfXK_Down(0x1004FF54),

  osfXK_EndLine(0x1004FF57),

  osfXK_BeginLine(0x1004FF58),

  osfXK_EndData(0x1004FF59),

  osfXK_BeginData(0x1004FF5A),

  osfXK_PrevMenu(0x1004FF5B),

  osfXK_NextMenu(0x1004FF5C),

  osfXK_PrevField(0x1004FF5D),

  osfXK_NextField(0x1004FF5E),

  osfXK_Select(0x1004FF60),

  osfXK_Insert(0x1004FF63),

  osfXK_Undo(0x1004FF65),

  osfXK_Menu(0x1004FF67),

  osfXK_Cancel(0x1004FF69),

  osfXK_Help(0x1004FF6A),

  osfXK_SelectAll(0x1004FF71),

  osfXK_DeselectAll(0x1004FF72),

  osfXK_Reselect(0x1004FF73),

  osfXK_Extend(0x1004FF74),

  osfXK_Restore(0x1004FF78),

  osfXK_Delete(0x1004FFFF),

  XK_Reset(0x1000FF6C),

  XK_System(0x1000FF6D),

  XK_User(0x1000FF6E),

  XK_ClearLine(0x1000FF6F),

  XK_InsertLine(0x1000FF70),

  XK_DeleteLine(0x1000FF71),

  XK_InsertChar(0x1000FF72),

  XK_DeleteChar(0x1000FF73),

  XK_BackTab(0x1000FF74),

  XK_KP_BackTab(0x1000FF75),

  XK_Ext16bit_L(0x1000FF76),

  XK_Ext16bit_R(0x1000FF77),
  ...
  SunXK_FA_Grave(0x1005FF00),

  SunXK_FA_Circum(0x1005FF01),

  SunXK_FA_Tilde(0x1005FF02),

  SunXK_FA_Acute(0x1005FF03),

  SunXK_FA_Diaeresis(0x1005FF04),

  SunXK_FA_Cedilla(0x1005FF05),

  SunXK_F36(0x1005FF10),

  SunXK_F37(0x1005FF11),

  SunXK_Sys_Req(0x1005FF60),

  SunXK_Print_Screen(0x0000FF61),

  SunXK_Compose(0x0000FF20),

  SunXK_AltGraph(0x0000FF7E),

  SunXK_PageUp(0x0000FF55),

  SunXK_PageDown(0x0000FF56),

  SunXK_Undo(0x0000FF65),

  SunXK_Again(0x0000FF66),

  SunXK_Find(0x0000FF68),

  SunXK_Stop(0x0000FF69),

  SunXK_Props(0x1005FF70),

  SunXK_Front(0x1005FF71),

  SunXK_Copy(0x1005FF72),

  SunXK_Open(0x1005FF73),

  SunXK_Paste(0x1005FF74),

  SunXK_Cut(0x1005FF75),

  SunXK_PowerSwitch(0x1005FF76),

  SunXK_AudioLowerVolume(0x1005FF77),

  SunXK_AudioMute(0x1005FF78),

  SunXK_AudioRaiseVolume(0x1005FF79),

  SunXK_VideoDegauss(0x1005FF7A),

  SunXK_VideoLowerBrightness(0x1005FF7B),

  SunXK_VideoRaiseBrightness(0x1005FF7C),

  SunXK_PowerSwitchShift(0x1005FF7D),
